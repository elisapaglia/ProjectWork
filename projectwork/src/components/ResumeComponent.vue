<template>
    <div id="resume">
        <hr>
        <h6 class="text-center pb-4 mt-5 pt-5">7+ YEARS OF EXPERIENCE</h6>
        <h2 class="text-center pb-5">My Resume</h2>

        <!--buttons-->
        <div class="container-fluid mb-5 d-flex justify-content-center w-100" id="pills-tab-wrapper">
            <ul class="nav nav-pills mb-3" id="pills-tab">
                <li class="nav-item">
                    <button class="nav-link active btn" id="pills-home-tab"
                        @click="activeTab = 'tab1'">Education</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link btn" id="pills-professional-tab" @click="activeTab = 'tab2'">Professional
                        Skills</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link btn" id="pills-experience-tab"
...
#pills-timeline .container {
    position: relative;
    width: 470px;
}

/* The circles on the timeline */
#pills-timeline .container::after {
    content: '';
    position: absolute;
    width: 15px;
    height: 15px;
...
#pills-timeline .container::after:hover {
    color: #ff014f;
}
